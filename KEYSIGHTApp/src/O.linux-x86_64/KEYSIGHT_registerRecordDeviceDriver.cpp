...
/* Generated from ../O.Common/KEYSIGHT.dbd */
...
epicsShareExtern reg_func pvar_func_AsynDriverInterfaceRegistrar,
    ...
    pvar_func_utagInitialize, pvar_func_vxi11RegisterCommands;
...
int KEYSIGHT_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/luo-yz/Desktop/epics";
...
/* KEYSIGHT_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"KEYSIGHT_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(KEYSIGHT_registerRecordDeviceDriver(*iocshPpdbbase));
}
